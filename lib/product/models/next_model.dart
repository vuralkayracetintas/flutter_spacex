...
//
//     final nextLaunchModel = nextLaunchModelFromMap(jsonString);

import 'dart:convert';

NextLaunchModel nextLaunchModelFromMap(String str) =>
    NextLaunchModel.fromMap(json.decode(str));

String nextLaunchModelToMap(NextLaunchModel data) => json.encode(data.toMap());
...
class NextLaunchModel {
  ...
  factory NextLaunchModel.fromMap(Map<String, dynamic> json) => NextLaunchModel(
